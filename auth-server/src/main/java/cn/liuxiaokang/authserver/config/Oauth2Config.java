package cn.liuxiaokang.authserver.config;
...
public class Oauth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                .redirectUris("http://127.0.0.1:8085/login", "http://localhost:8085/login", "http://www.baidu.com", "http://localhost:8085/api/login");
    }
